(function() {
  var Base, Block, Board, ColorBlock, Cursor, Game, Positional, Renderer, Ticker,
  ...
  Positional = (function(superClass) {
  ...
  Game = (function(superClass) {
    ...
    Game.prototype.ticker = new Ticker;
  ...
  Board = (function(superClass) {
    ...
    Board.prototype.cursor = new Cursor();
  ...
  Block = (function(superClass) {
    ...
    Block.prototype.swap = function(block) {
      var x, y;
      x = block.x;
      y = block.y;
      block.x = this.x;
  ...
  ColorBlock = (function(superClass) {
    ...
    ColorBlock.prototype.match = function(block) {
  ...
  Renderer = (function(superClass) {
    ...
    Renderer.prototype.renderBoard = function(board) {
      var ba, col, j, k, ref, ref1, row, str;
      ba = board.blockArray();
      str = "";
      for (row = j = 0, ref = board.width; 0 <= ref ? j <= ref : j >= ref; row = 0 <= ref ? ++j : --j) {
        str += "\n";
        for (col = k = 0, ref1 = board.height; 0 <= ref1 ? k <= ref1 : k >= ref1; col = 0 <= ref1 ? ++k : --k) {
          if ((ba[row] != null) && (ba[row][col] != null)) {
            str += "+";
          } else {
            str += '-';
          }
